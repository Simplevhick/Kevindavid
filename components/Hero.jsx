...
const Hero = ({ heading, message }) => {
  ...
  return (
    <>
      <div className="relative bg-[url('/assets/kev5.jpg')] flex items-center h-[95vh] justify-center mb-[7rem] bg-fixed bg-center bg-cover lg:relative lg:bg-[url('/assets/kev5.jpg')] lg:flex lg:items-center lg:h-[95vh] lg:justify-center lg:mb-[7rem] lg:bg-fixed lg:bg-center lg:bg-cover md:relative md:bg-[url('/assets/kev5.jpg')] md:flex md:items-center md:h-[95vh] md:justify-center md:mb-[7rem] md:bg-fixed md:bg-center md:bg-cover" id="hero">
