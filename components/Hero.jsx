...
const Hero = ({ heading, message, sub }) => {
  ...
  return (
    <>
      ...
      <div
        className="relative flex items-center justify-center w-[100%] h-[100vh] mb-[7rem] bg-fixed bg-center bg-cover custom-img lg:relative lg:flex lg:items-center lg:justify-center lg:w-full lg:h-screen lg:mb-[7rem] lg:bg-fixed lg:bg-center lg:bg-cover lg:custom-img md:relative md:flex md:items-center md:justify-center md:w-full md:h-screen md:mb-[7rem] md:bg-fixed md:bg-center md:bg-cover md:custom-img"
        id="hero"
      >
