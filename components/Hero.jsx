  ...
  return (
    <>
      ...
      <motion.section
        ...
        className="relative flex items-center justify-center max-w-[100%] h-[100vh] mb-[7rem] bg-scroll bg-center bg-cover custom-img"
        id="hero"
      >
        <motion.div
        ...
        >
          <h2 className="text-7xl lg:text-9xl md:text-8xl font-bold text-cs outfit ">
            {heading}
          </h2>
          <div className="">
            <h2 className="text-7xl lg:text-9xl  md:text-8xl font-bold outfit">
              {message}
            </h2>
          </div>
          {/* <div className=""> */}
            <h2 className="text-7xl lg:text-9xl  md:text-7xl font-bold text-cs outfit">
              {sub}
            </h2>
            <div className="mt-4">
              <ModalVideo />
