...
const About = () => {
  return (
    <div id="about">
      <div className="text-white m-3 mt-[65%] lg:flex lg:justify-between lg:text-white lg:mt-80 lg:m-7 lg:items-center md:flex md:justify-between md:text-white md:m-5 md:mt-80">
        <div className="">
