...
const Tour = () => {
  ...
  return (
    <div className="relative mb-[17rem] lg:mb-[35vh] md:mb-[30%] ">
    {/* <div className="mb-[17rem] lg:mb-[20%] md:mb-[30%] xl:mb-[4%] 2xl:mb-[20vh]"> */}
    <div
        className=""
        id="tours"
      >
        <div className="text-white bg-[url('/assets/kev5.jpg')] rounded-2xl flex h-[40rem] justify-center w-[100%]  lg:rounded-3xl lg:flex lg:h-[30rem] lg:justify-center lg:w-[100%] md:rounded-3xl md:flex md:h-[70vh] md:justify-center md:w-[100%] bg-scroll bg-center bg-cover bg-no-repeat">
