      ...
      <div className="p-4 lg:p-6 md:p-6  flex bg-red-500 rounded-xl items-center justify-between flex-1">
        <div className="flex items-center text-gray-200">
          <Image
            ...
            className=""
          />
          <div className="flex outfit text-gray-200 opacity-55 w-2 ml-[5px] m-5 leading-none">
            {currentSong.title}
          </div>
        </div>
...
//       // w-[90%] max-w-[400px] lg:max-w-[900px] md:max-w-[670px] text-white top-[80%] left-15 lg:top-[70%] lg:left-38 md:top-[40rem] md:left-15
//     >
